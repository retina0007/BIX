    ...
    <div className="max-w-5xl mx-auto relative z-10">
      <Reveal className="text-center space-y-8">
        ...
        <p className={`text-lg ${dark ? 'text-gray-400' : 'text-textGray'} max-w-2xl mx-auto`}>
          Hole dir 10+ Stunden Freizeit zurück und sichere dir den Social-Media-Bonus, bevor er weg ist. Keine Technik-Kenntnisse nötig. Wir richten alles für dich ein.
        </p>
